...
namespace VNS.HIS.UCs
{
    ...
    // and is therfore called TextBox, but ment is this class (AutoCompleteTextbox_old)
    public class AutoCompleteTextbox_old : TextBox
    {
        #region Fields
        ...
        public Janus.Windows.GridEX.EditControls.EditBox txtDrug_ID { get; set; }
        ...
        // the constructor
        public AutoCompleteTextbox_old()
            : base()
        {
        ...
        private void UpdateCurrentAutoCompleteList()
        {
            ...
            foreach (string Str in AutoCompleteList)
            {
                ...
                if (CaseSensitive)
                {
                    ...
                    { CurrentAutoCompleteList.Add(Str.Split('@')[1]); }
                }
                // or ignore case
                else
                {
