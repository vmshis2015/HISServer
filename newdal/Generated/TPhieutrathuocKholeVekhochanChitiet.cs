...
namespace VNS.HIS.DAL
{
	...
	public partial class TPhieutrathuocKholeVekhochanChitiet : ActiveRecord<TPhieutrathuocKholeVekhochanChitiet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int varIdPhieu,DateTime varNgayHethan,int varIdThuoc,decimal varGiaNhap,decimal varGiaBan,decimal? varDonGia,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,int varSoLuong,string varSoLo,int? varChietKhau,decimal varThanhTien,decimal varVat,long? varIdThuockho,long? varIdChuyen,string varMaNhacungcap,string varKieuThuocvattu,short? varThangDu,decimal? varGiaBhyt,DateTime? varNgayNhap)
		{
		...
		/// </summary>
		public static void Update(int varIdPhieuChitiet,int varIdPhieu,DateTime varNgayHethan,int varIdThuoc,decimal varGiaNhap,decimal varGiaBan,decimal? varDonGia,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,int varSoLuong,string varSoLo,int? varChietKhau,decimal varThanhTien,decimal varVat,long? varIdThuockho,long? varIdChuyen,string varMaNhacungcap,string varKieuThuocvattu,short? varThangDu,decimal? varGiaBhyt,DateTime? varNgayNhap)
		{
			TPhieutrathuocKholeVekhochanChitiet item = new TPhieutrathuocKholeVekhochanChitiet();
