...
{
    public partial class frm_Dangky_Kiemnghiem_old : Form
    {
        ...
        public frm_Dangky_Kiemnghiem_old(string nhomchidinh, byte chidinhgoi, byte chidinhchiphithem)
        {
            InitializeComponent();
            InitEvents();
        ...
        void InitEvents()
        {
            Load += new EventHandler(frm_Dangky_Kiemnghiem_old_Load);
            KeyDown += new KeyEventHandler(frm_Dangky_Kiemnghiem_old_KeyDown);
            FormClosing += new FormClosingEventHandler(frm_Dangky_Kiemnghiem_old_FormClosing);
        ...
        private void frm_Dangky_Kiemnghiem_old_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Dangky_Kiemnghiem_old_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Dangky_Kiemnghiem_old_KeyDown(object sender, KeyEventArgs e)
        {
