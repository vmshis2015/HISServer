...
namespace VNS.HIS.UI.NGOAITRU
{
    public partial class frm_quanlynhomchidinh_cls : Form
    {
        ...
        void InitEvents()
        {
            ...
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frm_quanlynhomchidinh_cls_FormClosing);
        ...
        private void frm_quanlynhomchidinh_cls_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            try
            {
                ...
                if (v_Payment_ID != -1)
                {
                    ...
                    else
                    {
                        ...
                        ActionResult actionResult = new KCB_THANHTOAN().HuyThanhtoan(KcbThanhtoan.FetchByID(v_Payment_ID), objLuotkham, ma_lydohuy, Utility.Int32Dbnull(grdRegExam.CurrentRow.Cells[KcbThanhtoan.Columns.IdHdonLog], -1), HUYTHANHTOAN_HUYBIENLAI);
                        switch (actionResult)
                        {
                            case ActionResult.Success:
                                foreach (DataRow _row in m_dataDataRegExam.Rows)
