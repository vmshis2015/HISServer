    ...
    public partial class BHYT_19A : UserControl
    {
     ...
     new Select().From(DmucLoaithuoc.Schema).Where(DmucLoaithuoc.KieuThuocvattuColumn).IsEqualTo("THUOC").ExecuteDataSet().Tables[0];
        ...
        private void PrintReport(bool view)
        {
            try
            {
                ...
                if (m_dataTH != null)
                {
                    ...
                    ReportDocument crpt = Utility.GetReport("BHYT_19A",ref tieude,ref reportname);
                    if (crpt == null) return;
                    ...
                    objForm.mv_sReportCode = "BHYT_19A";
        ...
        void LoadTH()
        {
            ...
            {
                m_dataTH =
                    new BAOCAO_BHYT().BHYT_19A(chkDate.Checked ? dtpFromDate.Value.ToString("dd/MM/yyyy") : "01/01/1900",
