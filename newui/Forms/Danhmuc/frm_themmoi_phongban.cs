...
namespace VNS.HIS.UI.DANHMUC
{
    public partial class frm_themmoi_phongban : Form
    {
        ...
        private Query m_Query = DmucKhoaphong.CreateQuery();
        #region "THUOC TINH"
        ...
        public frm_themmoi_phongban()
        {
            ...
            txtDepartment_Name.LostFocus+=new EventHandler(txtDepartment_Name_LostFocus);
            this.KeyPreview = true;
            //cboDeptType.SelectedIndex = 0;
            this.KeyDown+=new KeyEventHandler(frm_themmoi_phongban_KeyDown);
        ...
        private void frm_themmoi_phongban_Load(object sender, EventArgs e)
        {
            ...
            if(string.IsNullOrEmpty(txtID.Text))txtintOrder.Text = Utility.sDbnull(new Select(Aggregate.Max(DmucKhoaphong.Columns.SttHthi)).From(DmucKhoaphong.Schema).ExecuteScalar<int>()+1);
        ...
        void BindParent_ID()
        {
            ...
            DataBinding.BindDataCombox(cboParent_ID, dtDepartment, DmucKhoaphong.Columns.IdKhoaphong, DmucKhoaphong.Columns.TenKhoaphong);
        ...
        private bool  isValidData()
        {
            ...
            SqlQuery q = new Select().From(DmucKhoaphong.Schema).Where(DmucKhoaphong.Columns.MaKhoaphong).IsEqualTo(Utility.DoTrim(txtDepartment_Code.Text));
        ...
        private void ProcessData(int Parent_ID)
        {
            ...
            dr[DmucKhoaphong.Columns.NoitruNgoaitru] = optNgoaitru.Checked ? "NGOAI" : (optNoitru.Checked ? "NOI" : "CAHAI");
                ...
                if (record > 0)
                {
                    ...
                    foreach (DataRow dr in dsDepartment.Rows)
                    {
                        if (dr[DmucKhoaphong.Columns.IdKhoaphong].ToString() == Utility.sDbnull(txtID.Text, -1))
                        {
                            ...
                            dr[DmucKhoaphong.Columns.MaCha] = chkParent.Checked ? Utility.Int32Dbnull(cboParent_ID.SelectedValue, -1) : 0;
                            dr[DmucKhoaphong.Columns.DonGia] = Utility.DecimaltoDbnull(txtDeptFee.Text, 0);
        ...
        private void txtDepartment_Name_LostFocus(object sender, System.EventArgs e)
        {
