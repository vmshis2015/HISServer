...
namespace reports.Reports {
    ...
    public class BHYT_05A_CT : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "reports.Reports.BHYT_05A_CT.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBHYT_05A_CT : Component, ICachedReport {
        
        public CachedBHYT_05A_CT() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BHYT_05A_CT rpt = new BHYT_05A_CT();
            rpt.Site = this.Site;
            return rpt;
        }
