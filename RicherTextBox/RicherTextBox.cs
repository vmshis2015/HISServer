...
namespace RicherTextBox
{
    ...
    public partial class RicherTextBox : UserControl
    {
        ...
        public delegate void OnLostFocus(object sender,EventArgs e);
        public event OnLostFocus _OnLostFocus;
        ...
        public bool _AcceptsTab
        {
            get { return rtbDocument.AcceptsTab; }
            set { rtbDocument.AcceptsTab = value; }
        }
        public bool _Multiline
        {
            get { return rtbDocument.Multiline; }
            set { rtbDocument.Multiline = value; }
        }
        #endregion
        ...
        {
            InitializeComponent();
            rtbDocument.KeyDown += rtbDocument_KeyDown;
            rtbDocument.TextChanged += rtbDocument_TextChanged;
            rtbDocument.LostFocus += rtbDocument_LostFocus;
        }

        void rtbDocument_LostFocus(object sender, EventArgs e)
        {
            if (_OnLostFocus != null) _OnLostFocus(sender, e); 
        }

        void rtbDocument_TextChanged(object sender, EventArgs e)
        {
            if (_OnTextChanged != null) _OnTextChanged(sender, e);
        }

        void rtbDocument_KeyDown(object sender, KeyEventArgs e)
        {
            if (_OnKeyDown != null) _OnKeyDown(sender, e);
        }
